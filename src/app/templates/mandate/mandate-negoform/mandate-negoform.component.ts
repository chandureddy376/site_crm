...
export class MandateNegoformComponent implements OnInit {
  ...
  negodonewithfixing() {
    ...
    this.autoremarks = "Again Scheduled the Final Negotiation for " + this.selectedproperty_commaseperated + " On " + new Date($('#subnegonextactiondate').val()).toDateString() + " " + $('#subnegonextactiontime').val();
    var leadnegofixparam = {
      leadid: this.leadid,
