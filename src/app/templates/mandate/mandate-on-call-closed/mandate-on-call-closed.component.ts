...
@Component({
  selector: 'app-mandate-on-call-closed',
  templateUrl: './mandate-on-call-closed.component.html',
  styleUrls: ['./mandate-on-call-closed.component.css']
})
export class MandateOnCallClosedComponent implements OnInit {
  ...
  constructor(private router: Router,
    private route: ActivatedRoute, private _location: Location, private _mandateService: mandateservice) { }
