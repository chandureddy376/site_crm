  ...
  ngOnInit() {
    ...
    this._mandateService
      ...
      .subscribe(stagestatus => {
        ...
        if (this.activestagestatus && this.activestagestatus[0].stage == 'USV' && (this.activestagestatus[0].stagestatus == '1' || this.activestagestatus[0].stagestatus == '2') && this.activestagestatus[0].assignedvisits == null && (this.roleid == 50013 || this.roleid == 50014 || (this.leadDetails && this.leadDetails.roleid == 50013) || (this.leadDetails && this.leadDetails.roleid == 50014))) {
