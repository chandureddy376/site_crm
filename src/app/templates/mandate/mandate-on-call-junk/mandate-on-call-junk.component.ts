...
@Component({
  selector: 'app-mandate-on-call-junk',
  templateUrl: './mandate-on-call-junk.component.html',
  styleUrls: ['./mandate-on-call-junk.component.css']
})
export class MandateOnCallJunkComponent implements OnInit {
