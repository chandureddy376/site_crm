...
@Component({
  selector: 'app-mandate-followupform',
  templateUrl: './mandate-followupform.component.html',
  styleUrls: ['./mandate-followupform.component.css']
})
export class MandateFollowupformComponent implements OnInit {
  ...
  constructor(private router: Router,
    private route: ActivatedRoute, private _location: Location, private _mandateService: mandateservice, private echoService: EchoService,) { }
