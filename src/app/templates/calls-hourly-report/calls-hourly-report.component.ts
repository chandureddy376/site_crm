...
@Component({
  selector: 'app-calls-hourly-report',
  templateUrl: './calls-hourly-report.component.html',
  styleUrls: ['./calls-hourly-report.component.css']
})
export class CallsHourlyReportComponent implements OnInit {
