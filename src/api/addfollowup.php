...
include "db.php";
	...
	$demo = mysqli_real_escape_string($connect, $data->customer_id);
	$subscr = mysqli_real_escape_string($connect, $data->customer_phase);
	$enqr_date = date('y-m-d');
	date_default_timezone_set('Asia/Kolkata');
	$enqr_time = date("h:i A");
	// INSERT-DATA-IN-ACTIVELEADS

	$sql = "INSERT INTO active_leads (customer_IDPK, customer_id, customer_name, customer_number,
	 customer_mail, customer_location, customer_timeline, customer_purpose, customer_source, 
	 customer_proptype, customer_budget, customer_size, customer_assign, customer_status, customer_address, 
	 customer_loan, customer_date, customer_time, customer_phase, customer_comments) 
	VALUES ('$data->customer_IDPK', '$data->customer_id', '$data->customer_name', '$data->customer_number', 
	'$data->customer_mail', '$data->customer_location', '$data->customer_timeline', '$data->customer_purpose', 
	'$data->customer_source', '$data->customer_proptype', '$data->customer_budget', '$data->customer_size', 
	'$data->customer_assign', '$data->customer_status', '$data->customer_address', '$data->customer_loan',
	 '$data->customer_date', '$data->customer_time', '$data->customer_phase', '$data->customer_comments')";
	...
	customer_address ='$data->customer_address', customer_loan ='$data->customer_loan', customer_date = '$data->customer_date', customer_time = '$data->customer_time',
   ...
   // UPDATE-DATA-IN-ACTIVELEADS
	...
	// DELETE-DATA-FROM-ENQUIRY

	$sql = "DELETE FROM enquiry WHERE customer_id = '".$demo."'";
	if($data->customer_id){
	$qry = $connect->query($sql);
	}
   ...
   // UPDATE-DATA-IN-FOLLOWUP

   $sql2 = "UPDATE follow_up SET customer_name ='$data->customer_name', customer_number ='$data->customer_number',
	customer_mail ='$data->customer_mail', customer_location ='$data->customer_location', 
	customer_timeline ='$data->customer_timeline', customer_purpose ='$data->customer_purpose',
	customer_source ='$data->customer_source', customer_proptype ='$data->customer_proptype',
	customer_budget ='$data->customer_budget', customer_size ='$data->customer_size',
	...
	customer_date = '$data->customer_date', customer_time = '$data->customer_time',
	...
	customer_date = '$data->customer_date', customer_time = '$data->customer_time',
	customer_phase = '$data->customer_phase', customer_comments = '$data->customer_comments',
	customer_facetoface_date = '$data->customer_next_date', customer_facetoface_time = '$data->customer_next_time'
	WHERE customer_IDPK = $data->customer_IDPK ";
   	$qry = $connect->query($sql2);
   	if($data->customer_name){
	   }
	...
	$sql2 = "UPDATE usv SET customer_name ='$data->customer_name', customer_number ='$data->customer_number',
	customer_mail ='$data->customer_mail', customer_location ='$data->customer_location', 
	customer_timeline ='$data->customer_timeline', customer_purpose ='$data->customer_purpose',
	customer_source ='$data->customer_source', customer_proptype ='$data->customer_proptype',
	customer_budget ='$data->customer_budget', customer_size ='$data->customer_size',
	...
	$sql2 = "UPDATE rsv SET customer_name ='$data->customer_name', customer_number ='$data->customer_number',
	customer_mail ='$data->customer_mail', customer_location ='$data->customer_location', 
	customer_timeline ='$data->customer_timeline', customer_purpose ='$data->customer_purpose',
	customer_source ='$data->customer_source', customer_proptype ='$data->customer_proptype',
	customer_budget ='$data->customer_budget', customer_size ='$data->customer_size',
	...
	$sql = "INSERT INTO permanent_followup (customer_IDFK, customer_id, customer_name,
 	customer_next_date, customer_next_time, customer_followup_date, customer_followup_time) 
	VALUES ('$data->customer_IDPK', '$data->customer_id', '$data->customer_name',
	'$data->customer_next_date', '$data->customer_next_time', '$enqr_date', '$enqr_time')";
	if($data->customer_name){
	$qry = $connect->query($sql);
}	else {
...
if($subscr == "Follow Up"){
	...
	$sql = "INSERT INTO follow_up (customer_IDPK, customer_id, customer_name, customer_number, customer_mail, 
	...
	'$data->customer_mail', '$data->customer_location', '$data->customer_timeline', '$data->customer_purpose', 
	'$data->customer_source', '$data->customer_proptype', '$data->customer_budget', '$data->customer_size', 
	'$data->customer_assign', '$data->customer_status', '$data->customer_address', '$data->customer_date', 
	'$data->customer_time', '$data->customer_phase', '$data->customer_comments', '$data->customer_next_date', 
	'$data->customer_next_time')";
	if($data->customer_name){
	$qry = $connect->query($sql);
}	else {
	echo "Subscribe Failed";
...
if($subscr == "Face to Face Meeting"){
	$sql = "INSERT INTO face_to_face (customer_IDPK, customer_id, customer_name, customer_number, customer_mail, customer_location, customer_timeline, customer_purpose, customer_source, customer_proptype, customer_budget, customer_size, customer_assign, customer_status, customer_address, customer_date, customer_time, customer_phase, customer_comments, customer_facetoface_date, customer_facetoface_time) 
...
$sql = "INSERT INTO permanent_facetoface (customer_IDPK, customer_id, customer_name, customer_number, customer_mail, customer_location, customer_timeline, 
...
customer_address, customer_date, customer_time, customer_phase, customer_comments, customer_next_date, customer_next_time,
    customer_facetoface_location, customer_facetoface_date, customer_facetoface_time, customer_suggest_properties, customer_update_date, customer_update_time) 
	VALUES ('$data->customer_IDPK', '$data->customer_id', '$data->customer_name', '$data->customer_number',
	 '$data->customer_mail', '$data->customer_location', '$data->customer_timeline', '$data->customer_purpose',
	  '$data->customer_source', '$data->customer_proptype', '$data->customer_budget', '$data->customer_size',
	   '$data->customer_assign', '$data->customer_status','$data->customer_address', '$data->customer_date',
	    '$data->customer_time','$data->customer_phase', '$data->customer_comments', '$data->customer_next_date',
		 '$data->customer_next_time', '$data->customer_facetoface_location', '$data->customer_facetoface_date',
		  '$data->customer_facetoface_time', '$data->customer_suggest_properties', '$enqr_date', '$enqr_time')";
	if($data->customer_name){
	$qry = $connect->query($sql);
}	else {
	echo "Subscribe Failed";
...
customer_visited_place, customer_visit_date, customer_visit_time, customer_usv_updatedate, customer_usv_updatetime) 
	VALUES ('$data->customer_IDPK', '$data->customer_id', '$data->customer_name', '$data->customer_number', '$data->customer_mail', '$data->customer_location', '$data->customer_timeline', '$data->customer_purpose', '$data->customer_source', '$data->customer_proptype', '$data->customer_budget', '$data->customer_size', '$data->customer_assign', '$data->customer_status',
    '$data->customer_address', '$data->customer_date', '$data->customer_time', '$data->customer_phase', '$data->customer_comments', '$data->customer_next_date', '$data->customer_next_time',
    '$data->customer_visited_place', '$data->customer_visit_date', '$data->customer_visit_time', '$enqr_date', '$enqr_time')";
	if($data->customer_name){
	$qry = $connect->query($sql);
}	else {
	echo "Subscribe Failed";
